// GCP CIS 1.2.0 Rule equivalent 6.2.14
export default {
  id: 'gcp-nist-800-53-rev4-3.6',
  title:
    "GCP NIST 3.6 PostgreSQL database instance 'log_min_error_statement' database flag should be set appropriately",
  description: `The log_min_error_statement flag defines the minimum message severity level that are
