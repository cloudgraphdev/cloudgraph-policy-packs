...
import Gcp_CIS_130_31 from '../rules/gcp-cis-1.3.0-3.1'
import Gcp_CIS_130_32 from '../rules/gcp-cis-1.3.0-3.2'
import Gcp_CIS_130_33 from '../rules/gcp-cis-1.3.0-3.3'
import Gcp_CIS_130_34 from '../rules/gcp-cis-1.3.0-3.4'
import Gcp_CIS_130_35 from '../rules/gcp-cis-1.3.0-3.5'
import Gcp_CIS_130_36 from '../rules/gcp-cis-1.3.0-3.6'
import Gcp_CIS_130_37 from '../rules/gcp-cis-1.3.0-3.7'
import Gcp_CIS_130_38 from '../rules/gcp-cis-1.3.0-3.8'
import Gcp_CIS_130_39 from '../rules/gcp-cis-1.3.0-3.9'
...
describe('CIS Google Cloud Platform Foundations: 1.3.0', () => {
  ...
  describe('GCP CIS 3.9 Ensure no HTTPS or SSL proxy load balancers permit SSL policies with weak cipher suites', () => {
    ...
    describe('querygcpTargetHttpsProxy query:', () => {
      ...
      beforeAll(() => {
        const { queries, ...ruleMetadata} = Gcp_CIS_130_39
