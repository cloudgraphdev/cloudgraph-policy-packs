// GCP CIS 1.2.0 Rule equivalent 2.2
export default {
  id: 'gcp-pci-dss-3.2.1-logging-check-1',  
  title: 'Logging check 1: At least one project-level logging sink should be configured with an empty filter',
