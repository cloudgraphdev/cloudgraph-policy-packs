export default {
  id: 'azure-cis-1.3.1-2.8',  
  title: 'Azure CIS 2.8 Ensure that Azure Defender is set to On for Key Vault',  
  ...
  **Using PowerShell** 
  ...
  rationale: 'Enabling Azure Defender for Key Vault allows for greater defense-in-depth, with threat detection provided by the Microsoft Security Response Center (MSRC).',  
  ...
  Using Azure Command Line Interface 2.0 Use the below command to enable Standard pricing tier for Storage
