export default {
  id: 'azure-cis-1.3.1-5.2.2',  
  title: 'Azure CIS 5.2.2 Ensure that Activity Log Alert exists for Delete Policy Assignment',  
  ...
  Microsoft.Security/policyAssignments/delete
  4. Hover a mouse over Condition to ensure it is set to Whenever the Administrative
  Activity Log "Delete policy assignment (policyAssignments)" has "any"
