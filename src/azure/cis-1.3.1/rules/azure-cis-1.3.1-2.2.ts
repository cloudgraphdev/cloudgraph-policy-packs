export default {
  id: 'azure-cis-1.3.1-2.2',  
  title: 'Azure CIS 2.2 Ensure that Azure Defender is set to On for App Service',  
  ...
  **Using PowerShell**
      ...
      Get-AzAccount
      Get-AzSecurityPricing | Where-Object {$_.Name -eq 'AppServices'} | Select-Object Name, PricingTier
