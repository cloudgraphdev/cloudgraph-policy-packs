// similar to CIS 5.2.3
export default {
  id: 'azure-nist-800-53-rev4-3.7',
  title: 'Azure NIST 3.7 Ensure that Activity Log Alert exists for Create or Update Network Security Group',  
