export default {
  id: 'pci-dss-3.2.1-monitoring-check-7', 
  title: 'Monitoring Check 7: Monitor Activity Log Alert should exist for Create or Update or Delete SQL Server Firewall Rule',
