export default {
  id: 'pci-dss-3.2.1-monitoring-check-9',  
  title: 'Monitoring Check 9: Monitor Activity Log Alert should exist for Create Policy Assignment',  
  ...
  Activity Log "Create policy assignment (policyAssignments)" has "any"
  ...
  **Using Azure Command Line Interface 2.0**  
  ...
  Using Azure Command Line Interface Use the below command to create an Activity Log Alert for Create policy assignment
