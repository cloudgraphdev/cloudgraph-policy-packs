export default {
  id: 'pci-dss-3.2.1-monitoring-check-8',  
  title: 'Monitoring Check 8: Monitor Activity Log Alert should exist for Create or Update Security Solution',
  ...
  Activity Log "Create or Update Security Solutions (securitySolutions)"
  ...
  **Using Azure Command Line Interface**  
  ...
  rationale: `Monitoring for Create or Update Security Solution events gives insight into changes to the
        ...
        },
        {
          ...
          array_any: {
            and: [
              ...
              {
                path: '[*].equals',
                equal: 'microsoft.security/securitysolutions/write',
              },
            ]
          },
        },
