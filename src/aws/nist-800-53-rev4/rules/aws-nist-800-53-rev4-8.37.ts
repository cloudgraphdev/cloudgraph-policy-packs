export default {
  id: 'aws-nist-800-53-rev4-8.37',
  title: 'AWS NIST 8.37 VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP port 5800 (Virtual Network Computing), unless from ELBs',
  ...
  6. Ensure no rule exists that has a port range that includes port *5800* and has a *Source* of *0.0.0.0/0*`,
  ...
  **AWS CLI**
  ...
  Remove the inbound rule(s) that permits unrestricted ingress to port 5800:
      ...
      ws ec2 revoke-security-group-ingress --region <region> --group-name <group_name> --protocol <protocol> --port 5800 --cidr 0.0.0.0/0
            ...
            or: [
              ...
              },
              {
                and: [
                  {
                    path: '[*].fromPort',
                    lessThanInclusive: 5800,
                  },
                  {
                    path: '[*].toPort',
                    greaterThanInclusive: 5800,
                  },
                ],
              },
            ],
