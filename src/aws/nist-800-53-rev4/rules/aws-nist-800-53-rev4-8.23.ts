export default {
  id: 'aws-nist-800-53-rev4-8.23',
  title: 'AWS NIST 8.23 VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP port 2379 (etcd)',
  
  description: 'VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP port 2379 (etcd). Removing unfettered connectivity to an etcd server reduces the chance of exposing critical data.',
  ...
  6. Ensure no rule exists that has a port range that includes port *2379* and has a *Source* of *0.0.0.0/0*`,
  
  rationale: 'Removing unfettered connectivity to remote console services, such as etcd, reduces a server\'s exposure to risk.',
            ...
            or: [
              ...
              },
              {
                and: [
                  {
                    path: '[*].fromPort',
                    lessThanInclusive: 2379,
                  },
                  {
                    path: '[*].toPort',
                    greaterThanInclusive: 2379,
                  },
                ],
              },
            ],
