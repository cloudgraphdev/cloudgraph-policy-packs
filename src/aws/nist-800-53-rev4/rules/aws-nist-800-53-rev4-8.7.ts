export default {
  id: 'aws-nist-800-53-rev4-8.7',
  title: 'AWS NIST 8.7 VPC security group inbound rules should not permit ingress from any address to all ports and protocols',
  ...
  6. Ensure no rule exists that permit ingress from any address to all ports and protocols'`,
