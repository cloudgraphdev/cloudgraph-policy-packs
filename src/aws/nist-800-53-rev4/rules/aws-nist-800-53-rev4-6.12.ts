export default {
  id: 'aws-nist-800-53-rev4-6.12',  
  title: 'AWS NIST 6.12 S3 bucket object-level logging for read events should be enabled',
  ...
  - In AWS CloudTrail data events, click Configure in CloudTrail. Create a new CloudTrail if one doesn’t exist. For information about how to create trails in the CloudTrail console, see [Creating a Trail with the Console](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail-by-using-the-console.html).
