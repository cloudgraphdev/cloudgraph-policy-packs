...
// AWS CIS 1.2.0 Rule equivalent 3.4
export default {
  id: 'aws-nist-800-53-rev4-7.7',  
  title: 'AWS NIST 7.7 CloudWatch log metric filter and alarm for IAM policy changes should be configured',
