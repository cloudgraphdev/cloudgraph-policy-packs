export default {
  id: 'aws-nist-800-53-rev4-8.31',
  title: 'AWS NIST 8.31 VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP/UDP port 3020 (CIFS / SMB)',
  ...
  6. Ensure no rule exists that has a port range that includes port *3020* and has a *Source* of *0.0.0.0/0*`,
  
  rationale: 'Removing unfettered connectivity to remote console services, such as CIFS / SMB, reduces a server\'s exposure to risk.',
  ...
  **AWS CLI**
  ...
  Remove the inbound rule(s) that permits unrestricted ingress to port 3020:
      ...
      ws ec2 revoke-security-group-ingress --region <region> --group-name <group_name> --protocol <protocol> --port 3020 --cidr 0.0.0.0/0
            ...
            or: [
              ...
              },
              {
                and: [
                  {
                    path: '[*].fromPort',
                    lessThanInclusive: 3020,
                  },
                  {
                    path: '[*].toPort',
                    greaterThanInclusive: 3020,
                  },
                ],
              },
            ],
