export default {
  ...
  **AWS CLI**
  ...
  severity: 'medium',
  conditions: {  
    jq: '[.cloudtrail[] | select(.includeGlobalServiceEvents == "Yes")] | { "match" : (length == 1) }',
    path: '@',
    and: [
      {
        path: '@.match',
