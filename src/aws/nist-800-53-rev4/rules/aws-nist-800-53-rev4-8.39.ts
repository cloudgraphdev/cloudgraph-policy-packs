export default {
  id: 'aws-nist-800-53-rev4-8.39',
  title: 'AWS NIST 8.39 VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP port 80 (HTTP), unless from ELBs',
  
  description: 'Security groups provide stateful filtering of ingress/egress network traffic to AWS resources. AWS recommends that no security group allow unrestricted ingress access to port 80, unless it is from an AWS Elastic Load Balancer.',
  ...
  6. Ensure no rule exists that has a port range that includes port *80* and has a *Source* of *0.0.0.0/0*`,
  
  rationale: 'Removing unfettered connectivity to remote console services, such as HTTP, reduces a server\'s exposure to risk.',
  ...
  **AWS CLI**
  ...
  Remove the inbound rule(s) that permits unrestricted ingress to port 80:
      ...
      ws ec2 revoke-security-group-ingress --region <region> --group-name <group_name> --protocol <protocol> --port 80 --cidr 0.0.0.0/0
