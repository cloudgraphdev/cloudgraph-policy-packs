export default {
  id: 'aws-nist-800-53-rev4-8.17',
  title: 'AWS NIST 8.17 VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP/UDP port 138 (NetBios Datagram Service)',
  
  description: 'VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP/UDP port 138 (NetBios Datagram Service). Removing unfettered connectivity to a NetBios Datagram Service server reduces the chance of exposing critical data.',
  ...
  6. Ensure no rule exists that has a port range that includes port *138* and has a *Source* of *0.0.0.0/0*`,
  
  rationale: 'Removing unfettered connectivity to remote console services, such as NetBios Datagram Service, reduces a server\'s exposure to risk.',
            ...
            or: [
              ...
              },
              {
                and: [
                  {
                    path: '[*].fromPort',
                    lessThanInclusive: 138,
                  },
                  {
                    path: '[*].toPort',
                    greaterThanInclusive: 138,
                  },
                ],
              },
            ],
