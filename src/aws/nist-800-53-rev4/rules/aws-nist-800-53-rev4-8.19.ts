export default {
  id: 'aws-nist-800-53-rev4-8.19',
  title: 'AWS NIST 8.19 VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP port 1433 (MSSQL Server)',
  
  description: 'VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP/UDP port 1433 (MSSQL Server). Removing unfettered connectivity to a MSSQL Server server reduces the chance of exposing critical data.',
  ...
  6. Ensure no rule exists that has a port range that includes port *1433* and has a *Source* of *0.0.0.0/0*`,
  
  rationale: 'Removing unfettered connectivity to remote console services, such as MSSQL Server, reduces a server\'s exposure to risk.',
            ...
            or: [
              ...
              },
              {
                and: [
                  {
                    path: '[*].fromPort',
                    lessThanInclusive: 1433,
                  },
                  {
                    path: '[*].toPort',
                    greaterThanInclusive: 1433,
                  },
                ],
              },
            ],
