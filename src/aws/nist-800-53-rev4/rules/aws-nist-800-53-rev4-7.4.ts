...
// AWS CIS 1.2.0 Rule equivalent 3.12
...
export default {
  id: 'aws-nist-800-53-rev4-7.4',  
  title: 'AWS NIST 7.4 CloudWatch log metric filter and alarm for changes to VPC network gateways should be configured',
