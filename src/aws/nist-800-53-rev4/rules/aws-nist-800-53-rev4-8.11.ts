export default {
  id: 'aws-nist-800-53-rev4-8.11',  
  title: 'AWS NIST 8.11 VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP/UDP port 636 (LDAP SSL)',
  
  description: 'VPC security group rules should not permit ingress from ‘0.0.0.0/0’ to TCP/UDP port 636 (LDAP SSL). Removing unfettered connectivity to a LDAP SSL server reduces the chance of exposing critical data.',
  ...
  6. Ensure no rule exists that has a port range that includes port *636* and has a *Source* of *0.0.0.0/0*`,
  
  rationale: 'Removing unfettered connectivity to remote console services, such as LDAP SSL, reduces a server\'s exposure to risk.',
            ...
            or: [
              ...
              },
              {
                and: [
                  {
                    path: '[*].fromPort',
                    lessThanInclusive: 636,
                  },
                  {
                    path: '[*].toPort',
                    greaterThanInclusive: 636,
                  },
                ],
              },
            ],
