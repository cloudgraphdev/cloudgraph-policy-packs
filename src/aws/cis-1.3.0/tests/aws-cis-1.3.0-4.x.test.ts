...
import Aws_CIS_130_41 from '../rules/aws-cis-1.3.0-4.1'
import Aws_CIS_130_42 from '../rules/aws-cis-1.3.0-4.2'
import Aws_CIS_130_43 from '../rules/aws-cis-1.3.0-4.3'
import Aws_CIS_130_44 from '../rules/aws-cis-1.3.0-4.4'
import Aws_CIS_130_45 from '../rules/aws-cis-1.3.0-4.5'
import Aws_CIS_130_46 from '../rules/aws-cis-1.3.0-4.6'
import Aws_CIS_130_47 from '../rules/aws-cis-1.3.0-4.7'
import Aws_CIS_130_48 from '../rules/aws-cis-1.3.0-4.8'
import Aws_CIS_130_49 from '../rules/aws-cis-1.3.0-4.9'
import Aws_CIS_130_410 from '../rules/aws-cis-1.3.0-4.10'
import Aws_CIS_130_411 from '../rules/aws-cis-1.3.0-4.11'
import Aws_CIS_130_412 from '../rules/aws-cis-1.3.0-4.12'
import Aws_CIS_130_413 from '../rules/aws-cis-1.3.0-4.13'
import Aws_CIS_130_414 from '../rules/aws-cis-1.3.0-4.14'
import Aws_CIS_130_415 from '../rules/aws-cis-1.3.0-4.15'

const Aws_CIS_130_41_Filter_Pattern =
  '{ ($.errorCode =  "UnauthorizedOperation") || ($.errorCode = "AccessDenied") }'
const Aws_CIS_130_42_Filter_Pattern =
  '{ ($.errorCode = "ConsoleLogin") || ($.additionalEventData.MFAUsed != "Yes")  }'
const Aws_CIS_130_43_Filter_Pattern =
  '{ $.userIdentity.type = "Root" && $.userIdentity.invokedBy NOT EXISTS && $.eventType != "AwsServiceEvent" }'
const Aws_CIS_130_44_Filter_Pattern =
  '{ ($.eventName = DeleteGroupPolicy) || ($.eventName = DeleteRolePolicy) || ($.eventName = DeleteUserPolicy) || ($.eventName = PutGroupPolicy) || ($.eventName = PutRolePolicy) || ($.eventName = PutUserPolicy) || ($.eventName = CreatePolicy) || ($.eventName = DeletePolicy) || ($.eventName=CreatePolicyVersion) || ($.eventName=DeletePolicyVersion) || ($.eventName=AttachRolePolicy) || ($.eventName=DetachRolePolicy) || ($.eventName=AttachUserPolicy) || ($.eventName = DetachUserPolicy) || ($.eventName = AttachGroupPolicy) || ($.eventName = DetachGroupPolicy)}'
const Aws_CIS_130_45_Filter_Pattern =
  '{ ($.eventName = CreateTrail) || ($.eventName = UpdateTrail) || ($.eventName = DeleteTrail) || ($.eventName = StartLogging) || ($.eventName = StopLogging) }'
const Aws_CIS_130_46_Filter_Pattern =
  '{ ($.eventName = ConsoleLogin1) && ($.errorMessage = "Failed authentication") }'
const Aws_CIS_130_47_Filter_Pattern =
  '{ ($.eventSource = kms.amazonaws.com) && (($.eventName=DisableKey) || ($.eventName=ScheduleKeyDeletion)) }'
const Aws_CIS_130_48_Filter_Pattern =
  '{ ($.eventSource = s3.amazonaws.com) && (($.eventName = PutBucketAcl) || ($.eventName = PutBucketPolicy) || ($.eventName = PutBucketCors) || ($.eventName = PutBucketLifecycle) || ($.eventName = PutBucketReplication) || ($.eventName = DeleteBucketPolicy) || ($.eventName = DeleteBucketCors) || ($.eventName = DeleteBucketLifecycle) || ($.eventName = DeleteBucketReplication)) }'
const Aws_CIS_130_49_Filter_Pattern =
  '{ ($.eventSource = config.amazonaws.com) && (($.eventName=StopConfigurationRecorder)||($.eventName=DeleteDeliveryChannel) ||($.eventName=PutDeliveryChannel)||($.eventName=PutConfigurationRecorder)) }'
const Aws_CIS_130_410_Filter_Pattern =
  '{ ($.eventName = AuthorizeSecurityGroupIngress) || ($.eventName = AuthorizeSecurityGroupEgress) || ($.eventName = RevokeSecurityGroupIngress) || ($.eventName = RevokeSecurityGroupEgress) || ($.eventName = CreateSecurityGroup) || ($.eventName = DeleteSecurityGroup) }'
const Aws_CIS_130_411_Filter_Pattern =
  '{ ($.eventName = CreateNetworkAcl) || ($.eventName = CreateNetworkAclEntry) || ($.eventName = DeleteNetworkAcl) || ($.eventName = DeleteNetworkAclEntry) || ($.eventName = ReplaceNetworkAclEntry) || ($.eventName = ReplaceNetworkAclAssociation) }'
const Aws_CIS_130_412_Filter_Pattern =
  '{ ($.eventName = CreateCustomerGateway) || ($.eventName = DeleteCustomerGateway) || ($.eventName = AttachInternetGateway) || ($.eventName = CreateInternetGateway) || ($.eventName = DeleteInternetGateway) || ($.eventName = DetachInternetGateway) }'
const Aws_CIS_130_413_Filter_Pattern =
  '{ ($.eventName = CreateRoute) || ($.eventName = CreateRouteTable) || ($.eventName = ReplaceRoute) || ($.eventName = ReplaceRouteTableAssociation) || ($.eventName = DeleteRouteTable) || ($.eventName = DeleteRoute) || ($.eventName = DisassociateRouteTable) }'
const Aws_CIS_130_414_Filter_Pattern =
  '{ ($.eventName = CreateVpc) || ($.eventName = DeleteVpc) || ($.eventName = ModifyVpcAttribute) || ($.eventName = AcceptVpcPeeringConnection) || ($.eventName = CreateVpcPeeringConnection) || ($.eventName = DeleteVpcPeeringConnection) || ($.eventName = RejectVpcPeeringConnection) || ($.eventName = AttachClassicLinkVpc) || ($.eventName = DetachClassicLinkVpc) || ($.eventName = DisableVpcClassicLink) || ($.eventName = EnableVpcClassicLink) }'
const Aws_CIS_130_415_Filter_Pattern =
...
describe('CIS Amazon Web Services Foundations: 1.3.0', () => {
  ...
  describe('AWS CIS 4.1 Ensure a log metric filter and alarm exist for unauthorized API calls', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_41_Filter_Pattern)
  ...
  describe('AWS CIS 4.2 Ensure a log metric filter and alarm exist for Management Console sign-in without MFA (Scored)', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_42_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
  ...
  describe("AWS CIS 4.3  Ensure a log metric filter and alarm exist for usage of 'root' account", () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_43_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
  ...
  describe('AWS CIS 4.4 Ensure a log metric filter and alarm exist for IAM policy changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_44_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
  ...
  describe('AWS CIS 4.5 Ensure a log metric filter and alarm exist for CloudTrail configuration changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_45_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
  ...
  describe('AWS CIS 4.6 Ensure a log metric filter and alarm exist for AWS Management Console authentication failures', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_46_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_46_Filter_Pattern)
  ...
  describe('AWS CIS 4.7 Ensure a log metric filter and alarm exist for disabling or scheduled deletion of customer created CMKs',
    () => {
      ...
      test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
        const data = get4xValidResponse(Aws_CIS_130_47_Filter_Pattern)
        await testRule(data, Result.PASS)
      })
      test('Security Issue when isLogging is false', async () => {
        const data = get4xValidResponse(Aws_CIS_130_47_Filter_Pattern)
  ...
  describe('AWS CIS 4.8 Ensure a log metric filter and alarm exist for S3 bucket policy changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_48_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_48_Filter_Pattern)
  ...
  describe('AWS CIS 4.9 Ensure a log metric filter and alarm exist for AWS Config configuration changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_49_Filter_Pattern)
  ...
  describe('AWS CIS 4.10 Ensure a log metric filter and alarm exist for security group changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_410_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_410_Filter_Pattern)
  ...
  describe('AWS CIS 4.11 Ensure a log metric filter and alarm exist for changes to Network Access Control Lists (NACL)', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_411_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_411_Filter_Pattern)
  ...
  describe('AWS CIS 4.12 Ensure a log metric filter and alarm exist for changes to network gateways', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_412_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_412_Filter_Pattern)
  ...
  describe('AWS CIS 4.13 Ensure a log metric filter and alarm exist for route table changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_413_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_413_Filter_Pattern)
  ...
  describe('AWS CIS 4.14 Ensure a log metric filter and alarm exist for VPC changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for security group changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_414_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_414_Filter_Pattern)
  ...
  describe('AWS CIS 4.15 Ensure a log metric filter and alarm exists for AWS Organizations changes', () => {
    ...
    test('No Security Issue when there are metric filters and alarms for AWS Organizations changes', async () => {
      const data = get4xValidResponse(Aws_CIS_130_415_Filter_Pattern)
      await testRule(data, Result.PASS)
    })
    test('Security Issue when isLogging is false', async () => {
      const data = get4xValidResponse(Aws_CIS_130_415_Filter_Pattern)
