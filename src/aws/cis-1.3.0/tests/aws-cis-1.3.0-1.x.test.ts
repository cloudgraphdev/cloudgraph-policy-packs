...
import Aws_CIS_130_115 from '../rules/aws-cis-1.3.0-1.15'
import Aws_CIS_130_116 from '../rules/aws-cis-1.3.0-1.16'
import Aws_CIS_130_117 from '../rules/aws-cis-1.3.0-1.17'
...
describe('CIS Amazon Web Services Foundations: 1.4.0', () => {
  ...
  describe('AWS CIS 1.12 Ensure credentials unused for 90 days or greater are disabled', () => {
    const getTestRuleFixture = (
      passwordLastUsed: string,
      lastUsedDate: string
    ): CIS1xQueryResponse => {
  ...
  describe('AWS CIS 1.20 Ensure that S3 Buckets are configured with Block public access (bucket settings)', () => {
    const getTestRuleFixture = (
      blockPublicAcls: string,
      ignorePublicAcls: string,
      blockPublicPolicy: string,
  ...
  describe('AWS CIS 1.21 Ensure that IAM Access analyzer is enabled', () => {
    const getTestRuleFixture = (
