// AWS CIS 1.4.0 Rule equivalent 2.1.5
export default {
  id: 'aws-cis-1.3.0-1.20',  
  title: 'AWS CIS 1.20 Ensure that S3 Buckets are configured with \'Block public access (bucket settings)\'',
