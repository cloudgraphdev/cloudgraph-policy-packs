export default {
  id: 'aws-cis-1.5.0-1.21',  
  title: 'AWS CIS 1.21 Ensure IAM users are managed centrally via identity federation or AWS Organizations for multi-account environments',
