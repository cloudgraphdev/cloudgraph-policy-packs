export default {
  ...
  audit: `Perform the following to determine if security contact information is present: From Console:
  ...
  remediation: `Perform the following to establish security contact information: From Console:
