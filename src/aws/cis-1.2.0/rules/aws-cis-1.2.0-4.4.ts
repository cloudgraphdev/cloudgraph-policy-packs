export default {
  id: 'aws-cis-1.2.0-4.4',  
  title: 'AWS CIS 4.4 Ensure routing tables for VPC peering are "least access"',  
  ...
  remediation: `Remove and add route table entries to ensure that the least number of subnets or hosts as is required to accomplish the purpose for peering are routable. Via CLI:
  ...
  references: ['http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide/peering-configurations-partial-access.html'],
  severity: 'high',
}
