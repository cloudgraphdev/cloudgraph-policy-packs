...
export default {
  id: 'aws-cis-1.2.0-2.3',  
  title: 'AWS CIS 2.3 Ensure the S3 bucket used to store CloudTrail logs is not publicly accessible',  
  ...
  references: ['CCE-78915-6', 'https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_principal.html'],  
  gql: `{
    queryawsCloudtrail {
      id
      __typename
