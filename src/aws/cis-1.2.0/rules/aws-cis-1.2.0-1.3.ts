export default {
  ...
  description: `AWS IAM users can access AWS resources using different types of credentials, such as
   ...
   **Ensure unused credentials does not exist:**
   ...
   - When a user having an *access_key_x_active* (where x is 1 or 2) to *TRUE* and corresponding *access_key_x_last_used_date* is set to *N/A*, *ensure_access_key_x_last_rotated* is less than 90 days ago.`,
...
`,
  references: ['CCE-78900-8', 'CIS CSC v6.0 #16.6'],
  gql: `{
   queryawsIamUser {
      id
      arn
